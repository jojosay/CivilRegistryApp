    ...
    public partial class UserActivityLogView : UserControl
    {
        ...
        private async Task LoadActivitiesAsync()
        {
            try
            {
                ...
                ActivityLogDataGrid.IsEnabled = false;
                ...
                // Get activities
                _allActivities = (await _userActivityService.GetAllActivitiesAsync(
                ...
                // Enable DataGrid
                ActivityLogDataGrid.IsEnabled = true;
            ...
            try
            {
                ...
                if (_allActivities != null)
                {
                    _filteredActivities = _allActivities.Where(a =>
                        ...
                        a.ActivityType.ToLower().Contains(searchText)
                    ).ToList();
                }
                else
                {
